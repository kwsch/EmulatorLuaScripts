...
local Apkms={0x02257BC4,0x02257BC4+0xDC*1,0x02257BC4+0xDC*2,0x02257BC4+0xDC*3,0x02257BC4+0xDC*4,0x02257BC4+0xDC*5}
local Bpkms={0x02258124,0x02258124+0xDC*1,0x02258124+0xDC*2,0x02258124+0xDC*3,0x02258124+0xDC*4,0x02258124+0xDC*5}
...
table=joypad.get(1)
        ...
        if enbl==0 then on=(on+1)%2 enbl=1  -- Enable the Data Parsing
...
print() print("=====Player 1=====")
		Apkm1=getpkm(0,1) 
			...
			if Aspec1~="None" then snag=snag+1
